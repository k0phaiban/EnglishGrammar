...
export default class Spoken extends Component {
    constructor(){
        super();  
        this.state ={  
          status: false,
          ...
          { this.state.status2 ? <View>
              <TouchableOpacity onPress={this.ShowHideTextComponentView}>
                <View style={styles.item}>
                  <Text style={styles.text1}>Spoken English</Text>
          ...
          { this.state.status ? <View>
              <TouchableOpacity onPress={this.ShowHideTextComponentView}>
                <View style={styles.item2}>
                  <Text style={styles.text2}>Spoken English</Text>
