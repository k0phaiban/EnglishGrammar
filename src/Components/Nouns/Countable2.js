...
export default function Countable2({navigation}){
        return (
            <View>
                ...
                <ScrollView style={{backgroundColor: '#f1f0f1', marginBottom: 60}}>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Nouns that can be countable or uncountable</Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/tea_order.png')}
                            style={styles.logo}
                        />
                        <View style={{flexDirection: "row"}}>
                    ...
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Ways of counting uncountable nouns </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/milk.png')}
