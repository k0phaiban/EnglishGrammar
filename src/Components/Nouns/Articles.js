                ...
                <ScrollView style={{backgroundColor: '#f1f0f1', marginBottom: 60}}>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>The indefinite article a/an</Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/articles_1.png')}
                            style={styles.logo}
                        />
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 12,marginTop: 20}}>
                                ...
                                whether they refer to a general or a specific object. 
                        ...
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 12,marginTop: 20}}>
                                Article an before words that begin with a vowel 
                                sound, (a, e. i. o. U) and when you do not pronounce the 

                            </Text>
                        </View>
                        <View>
                            <Text style={{fontSize: 12,fontStyle: "italic",marginLeft: 30,marginBottom: 20,marginTop: 10}}>an apple an orange 
                                an umbrella an hour </Text>
                            <Text style={{fontSize: 12,fontStyle: "italic",marginLeft: 30,marginBottom: 20}}>                                
                                an honour 
                                an architect </Text>
                        </View>
                    </View>
                    <QuestionsShort title="Choose the correct form:" question="Is there __________ bank here? " answer1="a" answer2="an" answer="a"></QuestionsShort>
                    <QuestionsShort title="Choose the correct form:" question="Is there ____  university in Sydney?  " answer1="a" answer2="an" answer="a"></QuestionsShort>
                    <QuestionsShort title="Choose the correct form:" question="Who lives in ______ house? " answer1="an" answer2="a" answer="the"></QuestionsShort>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            <View style={styles.iconnumber}>
                                <Text style={{fontSize: 10}}>2</Text>
                            </View>
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Use </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/articles_2.png')}
                    ...
                    " answer1="a" answer2="an" answer3="none"  answer="a"></QuestionsLong>
