...
export default function UsesOfArticles({navigation}){
        return (
            <View>
                ...
                <ScrollView style={{backgroundColor: '#f1f0f1', marginBottom: 60}}>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Words with 'the' </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/uses_a_an_the_1.png')}
                            style={styles.logo}
                        />
                        <View style={{flexDirection: "row"}}>
                    ...
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Words without 'a'/'an' or 'the' </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/uses_a_an_the_2.png')}
