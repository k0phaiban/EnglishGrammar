...
export default function Articles2({navigation}){
        return (
            <View>
                ...
                <ScrollView style={{backgroundColor: '#f1f0f1', marginBottom: 60}}>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Use of article 'the' </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/articles2_1.png')}
                            style={styles.logo}
                        />
                        <View style={{flexDirection: "row"}}>
                    ...
                    <View style={styles.div}>
                        ...
                        <ImageBackground
                            source={require('../Image/articles2_2.png')}
