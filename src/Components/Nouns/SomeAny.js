...
export default function SomeAny({navigation}){
        return (
            <View>
                ...
                <ScrollView style={{backgroundColor: '#f1f0f1', marginBottom: 60}}>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Some and Any with a noun </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/some_any_1.png')}
                            style={styles.logo}
                        />
                        <View style={{flexDirection: "row"}}>
                    ...
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Some and Any without a noun </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/some_any_2.png')}
