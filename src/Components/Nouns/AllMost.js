...
export default function AllMost({navigation}){
        return (
            <View>
                ...
                <ScrollView style={{backgroundColor: '#f1f0f1', marginBottom: 60}}>
                    <View style={styles.div}>
                        <View style={{flexDirection: "row"}}>
                            ...
                            <Text style={{fontSize: 14,fontWeight: "bold"}}>Form </Text>
                        </View>
                        <ImageBackground
                            source={require('../Image/allmost_1.png')}
                            style={styles.logo}
                        />
                        <View style={{flexDirection: "row"}}>
                    ...
                    <View style={styles.div}>
                        ...
                        <ImageBackground
                            source={require('../Image/allmost_2.png')}
